...
#
# Environment:
#   CONTAINER_NAME   Name for the container (default: opencode-dev)
...
CONTAINER_NAME="${CONTAINER_NAME:-opencode-dev}"
...
case "$ARCH" in
    x86_64|amd64)
        IMAGE_TAG="opencode-dev:x86_64"
        DOCKERFILE="Dockerfile"
        ;;
    arm64|aarch64)
        IMAGE_TAG="opencode-dev:arm64"
...
main() {
    echo ""
    log_info "OpenCode Development Environment"
    echo ""
