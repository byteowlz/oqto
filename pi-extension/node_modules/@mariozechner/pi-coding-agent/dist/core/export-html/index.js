 ...
 */
async function buildCodexInjectionInfo(tools) {
    ...
    const instructionsText = instructions || "(Codex instructions not cached. Run a Codex request to populate the local cache.)";
    return {
