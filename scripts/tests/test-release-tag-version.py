...
class ReleaseTagTests(unittest.TestCase):
    def invoke(self, tag: str, cargo_version: str = "0.5.0", deps_version: str = "0.5.0",
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            package.write_text(json.dumps({"version": package_version}))
    ...
    def test_matching_tag_and_declared_versions_pass(self):
        ...
        self.assertEqual(self.invoke("v1.2.3-rc.1", "1.2.3-rc.1", "1.2.3-rc.1", "1.2.3-rc.1").returncode, 0)
    ...
    def test_dependency_pin_divergence_fails(self):
        ...
        self.assertNotEqual(self.invoke("v0.5.0", package_version="0.4.9").returncode, 0)
