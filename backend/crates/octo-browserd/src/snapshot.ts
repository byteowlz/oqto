 ...
 *
 * Usage:
 *   octo-browserd snapshot              # Full snapshot
 *   octo-browserd snapshot -i           # Interactive elements only
 *   octo-browserd snapshot --depth 3    # Limit depth
 *   octo-browserd click @e2             # Click element by ref
 */
