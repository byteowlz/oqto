...
const BOOTSTRAP_GREETINGS_EN: &[&str] = &[
    "Welcome to Oqto. I will help set up your workspace. What kind of work will you do here?",
    ...
    "Welcome to Oqto. I will guide setup and capture your preferences. What should we focus on?",
    "Welcome. I will help configure your workspace and assistant. What is your first task?",
];

const BOOTSTRAP_GREETINGS_DE: &[&str] = &[
    "Willkommen bei Oqto. Ich richte den Workspace ein. Woran werden Sie hier arbeiten?",
    ...
    "Willkommen bei Oqto. Ich erfasse Ihre Einstellungen. Worauf sollen wir uns konzentrieren?",
...
pub async fn bootstrap_onboarding(
    ...
    // the oqto_* user's home. In single-user mode, write directly.
    if is_multi_user {
        let linux_username = state
            .linux_users
            .as_ref()
