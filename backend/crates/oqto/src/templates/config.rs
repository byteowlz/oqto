...
pub const DEFAULT_TEMPLATES_REPO: &str = "https://github.com/byteowlz/oqto-templates";
...
pub struct OnboardingTemplatesConfig {
    ...
    /// Default: https://github.com/byteowlz/oqto-templates
    pub repo_url: String,
    ...
    /// Default: ~/.local/share/oqto/onboarding-templates
