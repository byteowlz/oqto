 ...
 *
 * Generates accessibility snapshots with embedded refs that can be
 ...
 *
 * Usage:
 *   oqto-browserd snapshot              # Full snapshot
 *   oqto-browserd snapshot -i           # Interactive elements only
 *   oqto-browserd snapshot --depth 3    # Limit depth
 *   oqto-browserd click @e2             # Click element by ref
 */
