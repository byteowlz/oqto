...
pub use handlers::{
    proxy_browser_stream_ws, proxy_fileserver, proxy_fileserver_for_workspace, proxy_opencode,
    proxy_opencode_agent, proxy_sldr, proxy_sldr_root, proxy_terminal_ws,
