...
### [oqto-p0h5] Sidebar search overhaul: fuzzy workspace search, Tab mode toggle, Pi-only message search, click-to-navigate, clean preview rendering, hover context modal (P2, feature)
