  ...
  const PersonaList = (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="px-4 pb-4">
        <button className="w-full flex items-center justify-between px-4 py-3 text-sm text-foreground hover:bg-primary/10 transition-colors border border-dashed border-border">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-sm truncate">{item.persona.name}</div>
                  <div className={cn(
                  ...
                  <div className={cn(
                    ...
                    <span>{item.sessions.length} {t.sessions}</span>
                    <span>·</span>
      ...
      {selectedPersona ? (
        <>
          ...
          <div className="p-4 md:p-6 border-b border-border">
            <div className="flex items-start gap-4">
              ...
              <div 
                ...
                style={{ backgroundColor: selectedPersona.persona.color || "#6366f1" }}
              >
                {getAvatarUrl(selectedPersona.persona, selectedPersona.sessions[0]) ? (
                  <img 
                    src={getAvatarUrl(selectedPersona.persona, selectedPersona.sessions[0])!} 
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-muted-foreground mt-2">
                  {selectedPersona.sessions.length} {t.sessions} · {t.lastActive}: {formatRelativeTime(selectedPersona.lastActive)}
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6">
            <h2 className="text-sm font-medium text-muted-foreground mb-4">{t.recentSessions}</h2>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className={cn(
                      ...
                      session.status === "stopped" ? "bg-muted text-muted-foreground" :
