            ...
            <div className="absolute top-2 right-2 flex gap-4 text-xs">
              ...
              <div className="flex items-center gap-1">
                <div
                  ...
                  style={{ backgroundImage: "repeating-linear-gradient(to right, currentColor 0, currentColor 3px, transparent 3px, transparent 8px)" }}
                ></div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {activeSessions.map((session, index) => (
                  <tr
                    key={session.id}
                    className={`border-b border-border hover:bg-accent transition-colors ${index % 2 === 0 ? "bg-card" : "bg-muted"}`}
                  >
