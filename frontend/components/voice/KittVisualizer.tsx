...
export function KittVisualizer({
  ...
  useEffect(() => {
    ...
    if (audioEnabled && (isListening || isSpeaking || isProcessing) && shouldShowDrain) {
      setBarMode('draining');
        ...
        {barMode === 'scanning' && (
          <div className="absolute inset-0">
            <div
              ...
              style={{
                background: 'linear-gradient(to right, rgba(239,68,68,0), rgba(239,68,68,0.6), rgba(239,68,68,0))',
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(to right, rgba(239,68,68,0), rgba(239,68,68,0.7), rgba(239,68,68,0))',
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(to right, rgba(239,68,68,0), rgba(239,68,68,0.85), rgba(239,68,68,0))',
            ...
            <div
              ...
              style={{
                boxShadow: '0 0 10px rgba(239,68,68,1), 0 0 20px rgba(239,68,68,0.8)',
                filter: 'blur(0.5px)',
                animationPlayState,
              }}
            />
        ...
        {barMode === 'draining' && !isBarNearEmpty && (
          <div
            ...
            style={{
              width: `${barWidth}%`,
              left: `${(100 - barWidth) / 2}%`,
              boxShadow: '0 0 6px rgba(239,68,68,0.9), 0 0 12px rgba(239,68,68,0.6)',
            }}
          />
        )}
      </div>
