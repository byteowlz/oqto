...
export function VoiceModeButton({
  ...
  const stateStyles = {
    idle: '',
    listening: 'bg-blue-500/20 text-blue-500 hover:bg-blue-500/30 border-blue-500/50',
    processing: 'bg-purple-500/20 text-purple-500 hover:bg-purple-500/30 border-purple-500/50',
    speaking: 'bg-green-500/20 text-green-500 hover:bg-green-500/30 border-green-500/50',
  };
