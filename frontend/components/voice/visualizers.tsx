...
import type { VoiceState, VisualizerType } from '@/lib/voice/types';
 ...
 */
export const VISUALIZER_REGISTRY: Record<string, {
 ...
 */
export function getVisualizer(id: VisualizerType): ComponentType<VisualizerProps> | null {
