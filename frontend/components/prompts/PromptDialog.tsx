...
export function PromptDetailDialog({ prompt, onRespond, onClose }: PromptDialogProps) {
  const [remaining, setRemaining] = useState(prompt ? getRemainingTime(prompt) : 0);
  ...
  return (
    <>
      ...
      <PromptDetailDialog
        ...
        onRespond={(action) => selectedPrompt && handleRespond(selectedPrompt.id, action)}
